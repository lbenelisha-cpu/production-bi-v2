    ...
    <section className="page">
      ...
      <div className="panel">
        ...
        <div className="admin-row">
          <input value={adminCode} onChange={e => setAdminCode(e.target.value)} placeholder="הזן קוד מנהל" type="password" />
          <span>קוד ברירת מחדל: 1542</span>
        </div>
      </div>
        ...
        <div className="line-grid">
          {settings.lines.map((line, idx) => (
            <div className="line-card" key={line.id}>
              ...
              <input disabled={!isAdmin} type="number" value={line.dailyTarget} onChange={e => updateLine(idx, e.target.value)} />
              <span>{line.unit} / יום</span>
            </div>
          ))}
        </div>
      </div>
